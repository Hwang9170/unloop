...
- **한/영 전환**: 인터페이스 언어를 한국어와 영어 중 자유롭게 변경
...
2. **언어 선택**: 화면 우측 상단에서 한국어/영어를 전환할 수 있습니다
3. **일기 작성**: 오늘의 일기를 자유롭게 작성하세요
4. **분석 실행**: "인사이트 분석하기" 버튼을 클릭하세요
5. **결과 확인**: 8개 카테고리의 인사이트 카드를 확인하세요
6. **히스토리**: 저장된 일기 목록에서 다시 선택해 상세 분석을 확인하세요
